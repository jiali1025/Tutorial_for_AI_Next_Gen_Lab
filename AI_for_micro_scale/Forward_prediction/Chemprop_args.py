...
from Chemprop_data import utils
from Chemprop_data import set_cache_mol, empty_cache
from Chemprop_features import get_available_features_generators
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        self.smiles_columns = Chemprop_data.utils.preprocess_smiles_columns(
            path=self.data_path,
