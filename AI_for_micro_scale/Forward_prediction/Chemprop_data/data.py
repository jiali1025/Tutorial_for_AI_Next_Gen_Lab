...
from Chemprop_features import get_features_generator, make_mol
from Chemprop_features import BatchMolGraph, MolGraph
from Chemprop_features import is_explicit_h, is_reaction, is_adding_hs, is_mol


# Cache of graph featurizations
'''
It is important to avoid repeated calculation of features
'''
CACHE_GRAPH = True
...
class MoleculeDatapoint:
    ...
    def __init__(self,
        ...
        """
        This is one of the most important data preprocess class. It will help to construct the molecule
        or reaction dataset. Thus the smiles is a list of strings.
        There can be additional features to atom or bonds which is already discussed in the representation part
        And also rule based features such as morgan fingerprints can be added to molecular fingerprints
...
class MoleculeDataset(Dataset):
    ...
    def batch_graph(self) -> List[BatchMolGraph]:
        ...
        """
        '''
        For this function actually, it will try to construct the mol_graph for each data point. And the simplest case 
        is mol_graph = MolGraph(m)
        ...
        if self._batch_graph is None:
            ...
            # The mol_graphs is a list of list [[],[],[],[].....] It is because for the MoleculeDatapoint
            # It may not only has one molecule. Thus the batch graph will be constructed according the following
            # double for loop. if it is single molecule . Then it is easily to batchize all single mol_graphs
    ...
    def features(self) -> List[np.ndarray]:
        ...
        This is mainly for the extra features. Normally not used.
    ...
    def data_weights(self) -> List[float]:
        ...
        This is for training loss weight calculation.
        """
    ...
    def normalize_features(self, scaler: StandardScaler = None, replace_nan_token: int = 0,
        ...
        However it is mainly used to normalize the additonal extra features. 
        """
    ...
    def normalize_targets(self) -> StandardScaler:
        ...
        This is useful especially when the the two targets are in different range of actual values. 
...
class MoleculeSampler(Sampler):
    ...
    def __init__(self,
        ...
        '''
        The class_balance is a good function that try to make the positive and negative is balanced in the 
        training process
        '''
...
class MoleculeDataLoader(DataLoader):
    ...
    '''
    This is kind of the key of preprocessing of pytorch to construct the dataloader. The pytorch dataloader
    class is very useful, that you can inherite from it and customized to any data you are working on. 
    '''
