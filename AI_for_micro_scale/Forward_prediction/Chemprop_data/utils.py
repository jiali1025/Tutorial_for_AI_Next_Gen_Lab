...
from Chemprop_features import load_features, load_valid_atom_or_bond_features, is_mol
...
def preprocess_smiles_columns(path: str,
    ...
    :param number_of_molecules: The number of molecules with associated SMILES for each
                           data point. Since reaction will have multiple molecules and so on.
...
def get_data_weights(path: str) -> List[float]:
    ...
    It is for the training with different weights to the samples.
